...
<div class="container-fluid">
	...
	<div class="text-right">
		<a class="btn btn-warning" href="${pageContext.request.contextPath}/admin/goods_add.jsp">添加商品</a>
	</div>
	...
	<table class="table table-bordered table-hover">
		...
		<c:forEach items="${p.list }" var="g">
			<tr>
				...
				<td><p>${pageContext.request.contextPath}${g.intro}</p></td>
				<td><p>${g.price}</p></td>
	...
	<br>
	<jsp:include page="${pageContext.request.contextPath}/page.jsp">
