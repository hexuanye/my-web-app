    ...
    <div class="container">
        <nav class="navbar navbar-default" role="navigation">
            <div class="navbar-header">
                ...
                <!-- 修改为使用 contextPath -->
                <h1 class="navbar-brand"><a href="${pageContext.request.contextPath}/index.jsp"></a></h1>
            </div>
            <!--navbar-header-->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <!-- 使用 contextPath 修正路径 -->
                    <li><a href="${pageContext.request.contextPath}/index.jsp" <c:if test="${param.flag==1}">class="active"</c:if>>首页</a></li>
                    <li class="dropdown">
